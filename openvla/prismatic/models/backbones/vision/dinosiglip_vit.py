...
class DinoSigLIPViTBackbone(VisionBackbone):
    def __init__(self, vision_backbone_id: str, image_resize_strategy: str, default_image_size: int = 224) -> None:
        ...
        if self.use_mast3r:
            import sys
            sys.path.append('/mnt/petrelfs/houzhi/Code/mast3r')
        ...
        if 'USE_INTERNVIT' in os.environ:
            # import ipdb;ipdb.set_trace()
            from transformers import AutoModel
            internvit_model = AutoModel.from_pretrained(
            ...
            internvit_model.resize_pos_embeddings(old_size=448,
                                                    new_size=224,
                                                 patch_size=patch_size)
            self.dino_featurizer = internvit_model    
    ...
    def forward(self, pixel_values: Dict[str, torch.Tensor]) -> torch.Tensor:
        ...
        if 'USE_INTERNVIT' in os.environ:
            # import ipdb;ipdb.set_trace()
            dino_patches = dino_patches.last_hidden_state
