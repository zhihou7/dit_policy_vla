...
# @dataclass
# class INTERNVL_v2_Reproduction(ModelConfig):
#     model_id: str = "internvl-v2+4b"
#     arch_specifier: str = "gelu-mlp"

#     vision_backbone_id: str = "internvit-vit-300M-448px"
#     llm_backbone_id: str = "phi‑3‑mini‑128k‑instruct"
...
# @dataclass
# class INTERNVL_v2_Reproduction_1B(ModelConfig):
#     model_id: str = "internvl-v2+1b"
#     arch_specifier: str = "gelu-mlp"

#     vision_backbone_id: str = "internvit-vit-300M-448px"
#     llm_backbone_id: str = "Qwen2‑0.5B‑Instruct"
...
#   =>> Note :: Run with `--dataset.type "llava-lvis4v-lrv"`
@dataclass
class INTERNVL2_4B_DINOSigLIP_224px(Exp_7B_One_Stage):
    model_id: str = "internvl2-224px+4b"
    vision_backbone_id: str = "dinosiglip-vit-so-224px"
    image_resize_strategy: str = "resize-naive"
    # llm_backbone_id: str = "llama2-7b-pure"
    llm_backbone_id: str = "vicuna-v15-7b"
